<!-- 看广告解锁下载的全屏遮罩。出图页共用，配合 useDownloadGate。
     有 videoUrl 时播真实视频广告；否则退回纯倒计时黑屏。 -->
<template>
...
defineProps<{ visible: boolean; remain: number; videoUrl?: string }>()
...
.ad-video { width: 100%; max-width: 420px; aspect-ratio: 16/10; object-fit: contain; background: #000; border-radius: 16px; margin-bottom: 20px; }
